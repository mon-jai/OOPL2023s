...
{
	int character_right = character.Left() + character.Width();
	int character_bottom = character.Top() + character.Height();
	int chest_and_key_right = chest_and_key.Left() + chest_and_key.Width();
	int chest_and_key_bottom = chest_and_key.Top() + chest_and_key.Height();

	if (
		character_bottom > chest_and_key.Top() && character.Top() < chest_and_key_bottom &&
		character_right > chest_and_key.Left() && character.Left() < chest_and_key_right
		) {
